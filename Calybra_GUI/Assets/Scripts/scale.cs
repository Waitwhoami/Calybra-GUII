...
{
    [SerializeField] public int tCounter = 0;              //How many objects are touching the left plate
    ...
    void Update()
    {   
        /*if ( ) {            //When there's no object touching the left plate, it gets reset to its
